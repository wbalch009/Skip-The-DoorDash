...
//  cost     — "$" or "$$" or "$$$"
//  serves   — number of servings (optional, shows on card)
...
const RECIPES = [
  ...
  // -------------------------------------------------------
  {
    ...
    prep: true,
    tags: ["black beans", "corn", "red onion", "cilantro", "lime", "smoky", "zesty", "hearty"],
...

  {
    ...
    prep: true,
    tags: ["black beans", "kidney beans", "northern beans", "corn", "bell pepper", "smoky", "spicy", "hearty", "bold"],
...

  {
    ...
    serves: 3,
    prep: true,
    tags: ["tofu", "broccoli", "sesame", "soy sauce", "ginger", "garlic", "scallions", "rice", "umami", "savory", "fresh", "garlicky"],
  ...
  // -------------------------------------------------------
  {
    ...
    prep: true,
    tags: ["white beans", "chicken", "green chiles", "corn", "red onion", "savory", "hearty", "mild"],
...

  {
    ...
    prep: true,
    tags: ["chicken thighs", "black beans", "corn", "cilantro-lime rice", "red onion", "Greek yogurt", "smoky", "zesty", "savory", "bold"],
...

  {
    ...
    prep: true, isLettuce: true,
    tags: ["chicken breast", "white beans", "cucumber", "red onion", "spinach", "lemon", "Greek yogurt", "sundried tomatoes", "bright", "fresh", "herby", "tangy"],
...

  {
    ...
    prep: true,
    tags: ["chicken thighs", "peanut butter", "soy sauce", "lime", "rice", "cabbage", "cilantro", "nutty", "savory", "tangy", "rich"],
...

  {
    ...
    prep: true,
    tags: ["chicken breast", "lentils", "soy sauce", "mirin", "bok choy", "rice", "umami", "savory", "mild", "earthy"],
...

  {
    ...
    prep: true,
    tags: ["chicken thighs", "potatoes", "gochujang", "soy sauce", "sesame", "green onion", "spicy", "umami", "bold", "savory"],
...

  {
    ...
    prep: true,
    tags: ["chicken breast", "white beans", "pasta", "garlic", "sundried tomatoes", "spinach", "savory", "garlicky", "herby", "light"],
  ...
  // -------------------------------------------------------
  {
    ...
    prep: true,
    tags: ["ground beef", "sweet potato", "black beans", "cilantro", "red onion", "smoky", "sweet", "hearty", "bold"],
...

  {
    ...
    prep: true,
    tags: ["ground beef", "lentils", "taco seasoning", "corn", "red onion", "cilantro", "smoky", "savory", "hearty", "bold"],
...

  {
    ...
    prep: true,
    tags: ["ground beef", "jasmine rice", "gochujang", "sesame", "egg", "spinach", "spicy", "umami", "bold", "savory"],
  ...
  // -------------------------------------------------------
  {
    ...
    prep: false,
    tags: ["salmon", "teriyaki", "edamame", "rice", "sesame", "cucumber", "sweet", "umami", "savory", "fresh"],
  ...
  // -------------------------------------------------------
  {
    ...
    prep: true,
    tags: ["Greek yogurt", "berries", "granola", "honey", "sweet", "fresh", "creamy"],
...

  {
    ...
    prep: true,
    tags: ["cottage cheese", "pineapple", "peach", "cinnamon", "sweet", "fresh", "creamy", "light"],
...

  {
    ...
    prep: true,
    tags: ["chickpeas", "smoked paprika", "cumin", "olive oil", "smoky", "crispy", "savory", "bold"],
...

  {
    ...
    prep: true,
    tags: ["eggs", "cottage cheese", "chives", "everything bagel seasoning", "savory", "creamy", "garlicky"],
...

  {
    ...
    prep: true,
    tags: ["black beans", "corn", "corn tortilla", "red onion", "cilantro", "zesty", "fresh", "savory", "light"],
...

  {
    ...
    prep: false,
    tags: ["Greek yogurt", "peanut butter", "apple", "cinnamon", "sweet", "nutty", "creamy", "tangy"],
...
{
    id: "r29",
    title: "Southwest shredded chicken salad",
    cal: 460, protein: "chicken", proteinG: 48, fiber: 10, cost: "$",
    serves: 6,
    prep: true,
    tags: ["chicken breast", "black beans", "corn", "bell pepper", "shredded cheese", "cilantro", "Greek yogurt", "lime", "smoky", "zesty", "tangy", "fresh"],
    desc: "Shredded chicken tossed with black beans, peppers, corn, and a creamy lime-Tajín dressing made with Greek yogurt and mayo. Great as a salad or stuffed into wraps.",
    ing: [
      "--- Chicken ---",
      "2 lb chicken breast",
      "1 tsp lime pepper",
      ...
      "½ red onion, diced",
      "½ can corn",
      "¼ cup shredded cheese (Mexican blend preferred)",
      ...
      "1 tsp honey",
      "1–2 tbsp hot sauce",
      "½ tsp chili lime seasoning (Tajín)",
      "½ tsp black pepper",
      "½ tsp garlic powder",
      "½ tsp paprika",
      "½ tsp cumin",
    ...
    steps: [
      "Slice chicken breasts into 1-inch wide strips. Coat with olive oil, lime pepper, garlic powder, onion powder, chili lime seasoning, oregano, paprika, and hot sauce.",
      "Air fry at 360°F for 10–12 min, or bake at 375°F for 15–18 min, until fully cooked through.",
      "Transfer cooked chicken to a mixing bowl. Shred with a hand mixer or two forks.",
      "While chicken bakes, combine Greek yogurt, mayo, lime juice, honey, hot sauce, chili lime seasoning, black pepper, garlic powder, paprika, cumin, and salt in a bowl. Whisk until smooth.",
      "In a larger bowl, combine black beans, red and green peppers, red onion, corn, shredded cheese, cilantro, and shredded chicken.",
      "Add desired amount of dressing to the salad bowl and mix until well combined.",
...

{
  ...
  //  fill in the fields, save, then:
  //  git add . && git commit -m "Add: recipe name" && git push
  // -------------------------------------------------------
